...
ApplyAccommodation, getAllUserDetails, getSingleUserDetails } = require('../controllers/basicController');
...
router.post('/basicApplyAccomodation',validateToken, ApplyAccommodation)
