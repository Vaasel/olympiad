...
const { allSports, addSport, genderSingleSports, genderTeamSports, applyIndividualSport, createTeam, joinTeam, getMembers, withdrawSingleSport, withdrawTeamSport,CompetitionTeamMembers } = require('../controllers/competitionsController');
...
router.get('/getCompetitionTeam/:competitionId', validateToken, CompetitionTeamMembers);
